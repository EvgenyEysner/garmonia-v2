...
import { ArrowLeft, Cookie } from "@lucide/vue";
...
<template>
  <main class="bg-sand-50 pt-28 pb-20 sm:pt-32">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
      <RouterLink
        to="/"
        class="mb-8 inline-flex items-center gap-2 text-sm font-medium text-gold-600 transition-colors hover:text-gold-700"
      >
        <ArrowLeft class="h-4 w-4" aria-hidden="true" />
        Zurück zur Startseite
      </RouterLink>

      <h1 class="text-3xl font-bold text-sand-900 sm:text-4xl">
      ...
      <div class="legal mt-8">
        ...
        <p>
          ...
          Weisungen in Bezug auf diese Daten befolgen. Wir setzen folgende(n) Hoster
          ein:
        </p>
        <address>
          netcup GmbH<br />
        ...
        <p>
          ...
          AUSÜBUNG ODER VERTEIDIGUNG VON RECHTSANSPRÜCHEN (WIDERSPRUCH NACH ART. 21 ABS.
          1 DSGVO).
        </p>
        <p>
        ...
        <p>
          ...
          eingeschränkt sein. Sofern weitere Cookies und Dienste auf dieser Website
        ...
        <p>
          <button
            type="button"
            class="inline-flex items-center gap-2 rounded-lg bg-gold-500 px-4 py-2 text-sm font-semibold text-white no-underline transition-colors hover:bg-gold-600"
            @click="openSettings"
          >
        ...
        <p>
          ...
          Anbieter dieses Dienstes ist die Meta Platforms Ireland Limited, Merrion
          Road, Dublin 4, D04 X2K5, Irland. Die erfassten Daten werden nach Aussage von
        ...
        <p>
          ...
          die Meta Platforms Ireland Limited, Merrion Road Dublin 4, Dublin, D04 X2K5,
        ...
        <p>
          ...
          Informationen über den Besuch dieser Website durch Sie. Wenn Sie in Ihrem
          ...
          verlinken. Dadurch kann Instagram den Besuch dieser Website Ihrem
        ...
        <p>
          ...
          sind wir und die Meta Platforms Ireland Limited, Merrion Road Dublin 4,
          Dublin, D04 X2K5, Irland gemeinsam für diese Datenverarbeitung verantwortlich
          (Art. 26 DSGVO). Die gemeinsame Verantwortlichkeit beschränkt sich dabei
          ausschließlich auf die Erfassung der Daten und deren Weitergabe an Facebook
          bzw. Instagram. Die nach der Weiterleitung erfolgende Verarbeitung durch
          Facebook bzw. Instagram ist nicht Teil der gemeinsamen Verantwortung. Die uns
        ...
        <h3>OpenStreetMap (Kartenansicht)</h3>
        <p>
          Auf unserer Kontaktseite binden wir eine interaktive Karte über OpenStreetMap
          (Leaflet) ein, um Ihnen unseren Standort anzuzeigen. Beim Laden der Karte kann
          Ihre IP-Adresse an die Server der OpenStreetMap Foundation bzw. der eingesetzten
          Tile-Server übermittelt werden. Weitere Informationen finden Sie in der
        ...
        <p>
          Die Einbindung erfolgt auf Grundlage unseres berechtigten Interesses an einer
          ansprechenden Darstellung unseres Standorts (Art. 6 Abs. 1 lit. f DSGVO). Sofern
          Sie in den Cookie-Einstellungen der Kategorie „Externe Medien“ zugestimmt haben,
          erfolgt die Verarbeitung zusätzlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO
          und § 25 Abs. 1 TDDDG.
        </p>

        <p class="!mt-10 text-sm text-sand-500">
          Quelle:
...
.legal :deep(h2) {
  ...
  font-size: 1.5rem;
  font-weight: 700;
  color: var(--color-sand-900, #1c1917);
}
...
.legal :deep(a) {
  color: var(--color-gold-600, #b38353);
...
.legal :deep(a:hover) {
  color: var(--color-gold-700, #8f6942);
}
