...
export const websiteApi = {
    // Send contact form
    sendContactForm: (data: { name: string; email: string; phone?: string; message: string }) => {
      return apiClient.post('/website/contact/', data)
    },
  
    // Call services
    getServices: () => {
      return apiClient.get('/website/services/')
    },
  
    // Call team members
    getTeamMembers: () => {
      return apiClient.get('/website/team/')
    },
  
    // Call gallery images
    getGalleryImages: () => {
      return apiClient.get('/website/gallery/')
    },
  }